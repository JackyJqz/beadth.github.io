...
export const relOfGains = (src, num) => {
  var bm = constants.DATA_SET.getView('VTI')
  var srcData = constants.DATA_SET.getView(src)
...
export const relItemOfGains = (src) => {
  ...
  let bm = constants.DATA_SET.getView(constants.DATA_SET_BM_REL_KEY).rows
  var srcItem
  var bmItem
  var _t
  // console.log(bm, src, '----')
